...
public class UnorderedWindow extends Window{
	...
	public UnorderedWindow(int wsize, ArrayList<? extends ProximityNode> termNodes, Index ind, QueryLikelihood mod) 
	{
	...
	private Set<Integer> queryTermsInWindow(ArrayList<Posting> postings, Set<Integer> unvisited, int start, int end)
	{
